...
<head>
    ...
    <title>Recuperar palavra-passe — Cardifys</title>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .fc-back { display: inline-flex; align-items: center; gap: 6px; font-size: 13px; font-weight: 600; color: rgba(255,255,255,0.42); text-decoration: none; margin-bottom: 22px; transition: color 0.15s; }
        .fc-back:hover { color: #c084fc; }
        ...
        .banner-ok { display: flex; align-items: flex-start; gap: 8px; background: rgba(52,211,153,0.08); border: 1px solid rgba(52,211,153,0.22); border-radius: 10px; padding: 11px 14px; font-size: 13px; font-weight: 500; color: #34d399; margin-bottom: 18px; line-height: 1.5; }
...
<div class="layout">
    ...
    <aside class="side-l">
        ...
        <div class="l-hero">
            <div class="slide-tag">
                ...
                <span class="slide-lbl">Recuperar acesso</span>
            </div>
            <h1 class="hero-heading">Sem stress.<br>Recupera já.</h1>
            <p class="hero-sub">Enviamos-te um link seguro para voltares à tua conta.</p>
        </div>
    ...
    <main class="side-r">
        <div class="form-card">
            <a href="{{ route('login') }}" class="fc-back">
            ...
            <div class="fc-icon">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zm0 0c0 1.657 1.007 3 2.25 3S21 13.657 21 12a9 9 0 10-2.636 6.364M16.5 12V8.25"/></svg>
            </div>

            <h2 class="fc-title">Recuperar palavra-passe</h2>
            <p class="fc-sub">Escreve o teu email e enviamos-te um link para definires uma nova palavra-passe.</p>
            ...
            <p class="fc-footer">Lembraste-te? <a href="{{ route('login') }}">Entrar</a></p>
        </div>
    </main>
