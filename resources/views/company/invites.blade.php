...
<div class="dashboard-header">
    ...
    <a href="{{ route('company.show', $company) }}" class="btn btn-secondary">
...
<div class="content-section">
    ...
    <form action="{{ route('company.invites.store', $company) }}" method="POST" class="invite-form">
        @csrf
        <div class="form-row">
                ...
                <tbody>
                    @foreach($pendingInvites as $invite)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('company.invites.cancel', $invite) }}" method="POST" onsubmit="return confirm('Cancelar este convite?')">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <tr>
                            ...
                            <td>
                                @if($member->id !== auth()->id())
                                    <form action="{{ route('company.members.remove', [$company, $member]) }}" method="POST" onsubmit="return confirm('Remover {{ $member->name }} da empresa?')">
                                        @csrf
                                        @method('DELETE')
