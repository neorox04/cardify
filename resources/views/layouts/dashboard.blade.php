    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('user.received-contacts') }}"
                   class="nav-item {{ request()->routeIs('user.received-contacts*') ? 'active' : '' }}">
                    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <div class="nav-section">
                <div class="nav-section-title">Faturação</div>
                <a href="{{ route('subscriptions.invoices') }}"
                   class="nav-item {{ request()->routeIs('subscriptions.invoices*') ? 'active' : '' }}">
                    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('admin.roadmap') }}"
                   class="nav-item {{ request()->routeIs('admin.roadmap*') ? 'active' : '' }}">
                    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
